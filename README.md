...
[![Docker Automated build](https://img.shields.io/docker/automated/chrisshort/docker-debian8-ansible.svg?maxAge=2592000)](https://hub.docker.com/r/chrisshort/docker-debian8-ansible/)
...
## How to Use
  ...
  1. [Install Docker](https://docs.docker.com/engine/installation/).
  2. Pull this image from Docker Hub: `docker pull chrisshort/docker-debian8-ansible:latest` (or use the tag you built earlier, e.g. `debian8-ansible`).
  3. Run a container from the image: `docker run --detach --privileged --volume=/sys/fs/cgroup:/sys/fs/cgroup:ro chrisshort/docker-debian8-ansible:latest /usr/lib/systemd/systemd` (to test my Ansible roles, I add in a volume mounted from the current working directory with ``--volume=`pwd`:/etc/ansible/roles/role_under_test:ro``).
